...
`AUGMENTS_YAGNI_AUDIT={"target":"{{exact target identity}}","context":"{{exact audit-input identity}}","partition":"{{stable partition ID}}","verdict":"{{clear | findings | inconclusive}}","report":"{{location or returned directly}}"}`.
