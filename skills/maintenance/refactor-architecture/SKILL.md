...
description: Use when an existing codebase's structure fights you — a single change bounces across many files, modules are thin wrappers that add little, tests and callers couple to internals — and you want to improve its structure. Skip for new design (use system-architecture) or a quick local fix.
---
