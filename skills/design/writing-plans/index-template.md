...
- [ ] 02 — {{task name}}   ·   `02-{{slug}}.md`
- [ ] 03 — {{task name}}   ·   `03-{{slug}}.md`

*Status: `[ ]` todo · `[~]` in progress · `[x]` done. Update as you execute — the index is the single source of truth for progress.*
