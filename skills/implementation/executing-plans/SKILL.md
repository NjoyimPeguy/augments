...
1. **Confirm you are not on the main branch.** For a plan of 3+ tasks, set up an isolated worktree *now* — don't rationalize "it's quick" into skipping this. Silent commits to main are the failure this prevents.
