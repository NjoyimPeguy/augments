...
> Review the requirements spec at `{{spec file}}`. Flag **only** issues that would lead to building the wrong thing or make a requirement impossible to test — skip prose style and detail-level variation. Check five things:
>
