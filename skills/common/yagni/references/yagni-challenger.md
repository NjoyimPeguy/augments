...
`AUGMENTS_YAGNI_CHALLENGE={"proposal":"{{exact proposal identity}}","context":"{{exact challenge-input identity}}","verdict":"{{lean | revise | decision | inconclusive}}","report":"{{location or returned directly}}"}`.
